...
function UserRatingForm({queriedUserId,queriedUserReviewsStats}:Props) {
  ...
  useEffect(()=>{
    ...
    const statsHexArray = [
      { attribute: 'SPD', score: (queriedUserReviewsStats.SPD/(20* queriedUserReviewsStats.numberOfReviews)*100) },
      { attribute: 'SHO', score: (queriedUserReviewsStats.SHO/(50* queriedUserReviewsStats.numberOfReviews)*100) },
      { attribute: 'PAS', score: (queriedUserReviewsStats.PAS/(50* queriedUserReviewsStats.numberOfReviews)*100) },
      { attribute: 'DRI', score: (queriedUserReviewsStats.DRI/(40* queriedUserReviewsStats.numberOfReviews)*100) },
      { attribute: 'DEF', score: (queriedUserReviewsStats.TDF/(50* queriedUserReviewsStats.numberOfReviews)*100) },
      { attribute: 'PHY', score: (queriedUserReviewsStats.PHY/(50* queriedUserReviewsStats.numberOfReviews)*100) },
    ];
    ...
    <>
      ...
      >
        ...
        {checkPreviousReview?(
          ...
          <Text textAlign="center">You already reviewed this user on {previousReviewDate} </Text>
        ):(
          <Box 
          display="flex"
          justifyContent="center"
          ...
          You can send an honest review to the player if you played together before.
        </Text>
        <Card
          display="grid"
          justifyContent="center"
        ...
        >
          ...
          <Box display="flex" flexDirection="column" gap={1}>
            <Text>
              <strong>GK Reach</strong> - Indicates the goalkeeper's coverage of
              the goal and the size of the area in which he can make saves:
            </Text>
          ...
          <Box display="flex" flexDirection="column" gap={1}>
            <Text>
              <strong>GK Positioning</strong> - Indicates the goalkeeper's ability to
              position himself correctly in order in order to save a shot:
            </Text>
