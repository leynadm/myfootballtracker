        ...
        {checkPreviousReview ? (
          ...
          >
            ...
            >
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  <strong>Acceleration</strong> - Indicates how quickly the
                  player is able to reach his top running speed:
                </Text>
            ...
            >
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  <strong>Shot Power</strong> - Indicates how hard the player
                  hits the ball when taking a shot at goal and still be
                  accurate:
                </Text>
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  <strong>Weak Foot Usage</strong> - Indicates how often a
                  player will use his weaker foot:
                </Text>
            ...
            >
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  <strong>Crossing</strong> - Indicates how accurately the
                  player crosses the ball during both normal running and free
                  kick set pieces:
                </Text>
            ...
            >
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  <strong>Strength</strong> - Indicates how good the player is
                  at winning challenges when coming into contact with another
                  player.
                </Text>
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  <strong>Stamina</strong> - Indicates the rate at which a
                  player will tire during a game:
                </Text>
            ...
            >
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  <strong>Standing Tackle</strong> - Indicates the ability of
                  the player to time standing tackles so that they win the ball
                  rather than give away a foul:
                </Text>
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  ...
                  player to time sliding tackles so that they win the ball
                  rather than give away a foul:
                </Text>
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  <strong>GK Reach</strong> - Indicates the goalkeeper's
                  coverage of the goal and the size of the area in which he can
                  make saves:
                </Text>
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                <Text>
                  ...
                  ability to position himself correctly in order in order to
                  save a shot:
                </Text>
