        ...
        >
          ...
          <Box display="flex" w="100%" justifyContent="space-around">
            <Box display="flex" alignItems="center" gap={1}>
              ...
              {`(${
                isNaN(
                  queriedUser.stats.defeats / queriedUser.stats.matchesPlayed
                )
                  ? "0.0%"
                  : (
          ...
          <AccordionItem>
            ...
            <AccordionPanel p={0} m={0} pb={1}>
              ...
              <Box>
                ...
                <Box display="flex" justifyContent="space-around">
                  <Box display="flex" alignItems="center" gap={1}>
                    {queriedUser.stats.foxInTheBox >
                    overallStatsData.foxInTheBox ? (
                      <MdKeyboardDoubleArrowUp color="green" />
                    ) : (
                      <MdKeyboardDoubleArrowDown color="red" />
                    )}
                    <Text>{queriedUser.stats.foxInTheBox}</Text>
                  </Box>
                  <IconButton
                    aria-label="highlight icon"
                    icon={<GiFox />}
                  ...
                  />
                  <Box display="flex" alignItems="center" gap={1}>
                    <Text>{overallStatsData.foxInTheBox}</Text>
                    {queriedUser.stats.foxInTheBox >=
                    overallStatsData.foxInTheBox ? (
                      <MdKeyboardDoubleArrowDown color="green" />
                    ) : (
