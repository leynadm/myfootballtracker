            ...
            >
              ...
              <Box display="flex" w="100%" justifyContent="space-around">
                <Box display="flex" alignItems="center" gap={1}>
                  ...
                  {`(${
                    isNaN(
                      queriedUser.stats.draws / queriedUser.stats.matchesPlayed
                    )
                      ? "0.00%"
                      : (
              ...
              <AccordionItem>
                ...
                <AccordionPanel p={0} m={0}>
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.bagABrace >
                        overallStatsData.bagABrace ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.slingshot >
                        overallStatsData.slingshot ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.hawkeye >
                        overallStatsData.hawkeye ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.noExcuses >
                        overallStatsData.noExcuses ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.laPulga >
                        overallStatsData.laPulga ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.finalWord >
                        overallStatsData.finalWord ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
              ...
              <AccordionItem>
                ...
                <AccordionPanel p={0} m={0}>
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.marksman >
                        overallStatsData.marksman ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
              ...
              <AccordionItem>
                ...
                <AccordionPanel p={0} m={0}>
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.theGiant >
                        overallStatsData.theGiant ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
              ...
              <AccordionItem>
                ...
                <AccordionPanel p={0} m={0}>
                  ...
                  <Box>
                    ...
                    <Box display="flex" justifyContent="space-around">
                      <Box display="flex" alignItems="center" gap={1}>
                        {queriedUser.stats.theKraken >
                        overallStatsData.theKraken ? (
                          <MdKeyboardDoubleArrowUp color="green" />
                        ) : (
                          <MdKeyboardDoubleArrowDown color="red" />
                        )}
